...
CSDN地址：[【YOLOv12部署至RK3588】模型训练→转换RKNN→开发板部署](https://blog.csdn.net/A_l_b_ert/article/details/157138142?spm=1001.2014.3001.5502)
...
src/yolov12.cpp：模型初始化、推理、反初始化等函数代码

include/postprocess.h、yolov12.h：各函数声明
